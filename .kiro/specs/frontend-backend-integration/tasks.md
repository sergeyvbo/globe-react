...
- [-] 6. Создание React компонентов для лидербордов. Для тестов использовать vitest, консольное окружение на dev = powershell.
...
- [ ] 7. Интеграция с игровыми компонентами. Для тестов использовать vitest, консольное окружение на dev = powershell.
